...
fn benched_fn<B: Backend + MerkleOps<BWSSha256MerkleHasher>>(
    ...
    CommitmentTreeProver::<B, BWSSha256MerkleHasher>::new(
        polys,
        LOG_BLOWUP_FACTOR,
        channel,
        twiddles,
...
fn bench_pcs<B: Backend + MerkleOps<BWSSha256MerkleHasher>>(c: &mut Criterion, id: &str) {
    ...
    let mut channel = BWSSha256Channel::new(BWSSha256Hash::default());
