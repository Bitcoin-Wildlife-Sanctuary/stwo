...
impl Fibonacci {
    ...
    pub fn prove(&self) -> Result<StarkProof<BWSSha256MerkleHasher>, ProvingError> {
...
mod tests {
    ...
    use crate::core::air::{AirProver, Component, ComponentProvers, ComponentTrace};
    ...
    fn test_composition_polynomial_is_low_degree() {
        ...
        let composition_polynomial_poly = components.compute_composition_polynomial(
            random_coeff,
            &component_traces,
        ...
        let points = components.components().mask_points(point);
